...
require 'db.php';
    ...
    $sql = "SELECT  id from registration where email_id = '$email'";
    ...
    if($count > 0 )
    {
       ...
       $url = "http://localhost/website/resetpassword.php?token=$str&email=$email";
           
       //$url = "http://domain.com/registration12/resetpassword.php?token=$str&email=$email";
            //
            mail($email,"Reset Password", "To Reset password pleas visit this: '$url'","From:dadipadmakara@gmail.com\r\n");

            mysqli_query($conn,"UPDATE registration set token = '$str' where email_id = '$email' ");

            $error = "Link has been sent to your mail";
    }
    else{
...
<html lang="en">
  ...
  <head>
    ...
    <title>Venkat Sai Life science</title>
                      ...
                      <div class="well">
                          <form action="forgotpassword.php" method="POST">
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="username" name="email"  required title="Please enter you email" placeholder="example@gmail.com">
                                  <span class="help-block"></span>
                              
                           <!--   <div id="loginErrorMsg" class="alert alert-error hide">Wrong username or password</div> -->
                             
                              <button type="submit" class="btn btn-success btn-block" name="submit">Request for password</button>
