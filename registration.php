                ...
                <div class="row">
                    ...
                    <div class="row">
                            ...
                            <form action="register.php" method="POST">
                                ...
                                <input id="ember360" class="form-control" placeholder="Name" name="name" type="text"  required >
                                <input id="ember361" class="form-control" placeholder="email_id" name="email_id" type="text" required>


                                <input id="ember360" class="form-control" placeholder="Username" name="username" type="text"  required>
                            
 
        

        <input type="password" placeholder="Password" id="password" name="pwd" class="form-control"required>
        <input type="password" placeholder="Confirm Password" id="confirm_password" class="form-control" name="cnfpwd"required>

       
   

                                <input id="ember361"  placeholder="companyname" name="companyname" type="text"   class="form-control">
                                <input id="ember361" class="form-control" placeholder="phone number" name="phone" type="text"  required>
